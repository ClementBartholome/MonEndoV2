...
import type {ScoreMetric} from "@/models/dashboard-bilan/score-metric";
import type {Goal} from "@/models/dashboard-bilan/goal";
import type {InsightWithAction} from "@/models/dashboard-bilan/insight-with-action";
