...
define(['./workbox-61f793f2'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    ...
    return request.method === "GET" && url.protocol === "https:" && url.hostname === "fonts.googleapis.com";
  }, new workbox.StaleWhileRevalidate({
  ...
  workbox.registerRoute(({
    ...
    return request.method === "GET" && url.protocol === "https:" && url.hostname === "fonts.gstatic.com";
